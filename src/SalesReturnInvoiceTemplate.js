...
import { CloudDownloadOutlined } from "@material-ui/icons";
  ...
  class BillGenerate extends Component {
    ...
    componentDidMount() {
      firebaseDb
        .database()
        .ref("Admin/Anu/SalesReturn").child(localStorage.getItem("SalesBill"))
        .on("value", (snapshot) => {
      ...
      firebaseDb
        .database()
        .ref("Admin/Anu/SalesReturn").child(localStorage.getItem("SalesBill")).child("Product")
        .on("value", (snapshot) => {
          if (snapshot.val() != null) {
